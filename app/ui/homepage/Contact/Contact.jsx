...
export default function Contact () {
    ...
    return <section className="bg-gray-900 flex justify-around gap-2 px-8 pt-24" id="contact">
        <div className='lg:flex justify-center items-center pb-3 pt-5 hidden ps-8'>
