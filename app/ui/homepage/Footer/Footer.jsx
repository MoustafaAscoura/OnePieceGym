    ...
    return <footer className="bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4">
                ...
                <div className="md:flex md:justify-between">
                    ...
                    <div className="md:flex flex-wrap justify-end gap-16">
                        <div>
                        ...
                        <div className='max-w-xs my-16 md:my-0 '>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li >
                                    <a href="https://www.facebook.com/profile.php?id=100091909050335" className="hover:underline ">Facebook</a>
                                </li>
                                <li className="my-4">
                                    <a href="https://www.instagram.com/1_piece_gym/" className="hover:underline">Instagram</a>
                                </li>
                                <li>
                                    <a href="https://wa.me/01155539381" className="hover:underline">Whatsapp</a>
                                </li>
                            </ul>
                        </div>
                        <div>
