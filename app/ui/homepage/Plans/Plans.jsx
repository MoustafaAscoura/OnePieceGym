...
export default function Plans () {
    return <section id="plans" class="bg-slate-950">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <div class="w-full flex flex-row overflow-x-scroll slider mt-8 gap-4">
                {/* Pricing Card */}
                <div class="flex-shrink-0 flex flex-col p-6 mx-auto min-w-xs max-w-sm text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                    ...
                    <a href="#contact" class="mt-auto text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-green-900">Get started</a>
                </div>
                {/* Pricing Card */}
                <div class="flex-shrink-0 flex flex-col p-6 mx-auto min-w-xs max-w-sm text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
